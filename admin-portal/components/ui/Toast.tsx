 ...
 *
 * Provides a global toast notification system using Zustand for state management.
 * Supports success, error, warning, and info toast types with auto-dismiss.
 *
 * Usage:
...
export const useToastStore = create<ToastStore>((set, get) => ({
  ...
  addToast: (toast) => {
    ...
    // Auto-remove after duration (errors stay longer)
