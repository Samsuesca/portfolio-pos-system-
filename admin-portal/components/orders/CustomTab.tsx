...
export default function CustomTab({
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Garment Type */}
      <div>
        <label className="block text-xs text-slate-600 mb-1">Tipo de Prenda *</label>
        <select
      ...
      <div className="grid grid-cols-2 gap-4">
        {/* Size */}
        <div>
          <label className="block text-xs text-slate-600 mb-1">Talla</label>
          <input
            type="text"
            value={customSize}
      ...
      {/* Notes */}
      <div>
        <label className="block text-xs text-slate-600 mb-1">Notas / Especificaciones</label>
        <textarea
          value={customNotes}
