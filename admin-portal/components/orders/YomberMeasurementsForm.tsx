...
import type { YomberMeasurements } from './types';
            ...
            <div key={field.key}>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder={field.placeholder}
                  disabled={disabled}
                  className={`w-full px-3 py-1.5 border border-slate-300 rounded text-sm pr-8 focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none ${
                    disabled ? 'bg-slate-100 cursor-not-allowed' : ''
                  }`}
                />
