...
const pathNames: Record<string, string> = {
  ...
  '/reports': 'Reportes',
  '/payroll': 'Nómina',
  '/workforce': 'Gestión Laboral',
  '/workforce/attendance': 'Asistencia',
  '/workforce/checklists': 'Checklists',
  '/workforce/performance': 'Rendimiento',
  '/workforce/responsibilities': 'Responsabilidades',
