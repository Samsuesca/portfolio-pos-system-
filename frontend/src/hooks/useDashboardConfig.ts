...
const ALL_QUICK_ACTIONS: Omit<QuickAction, 'highlight'>[] = [
  ...
  },
  {
    ...
    permission: 'accounting.close_register',
  },
  {
    id: 'alterations',
    label: 'Ver Arreglos',
...
export function useDashboardConfig(context?: {
  ...
  return useMemo(() => {
    ...
    const stats: StatsVisibility = {
      ...
      cashBalance: permissions.canViewGlobalBalances,
    ...
    const widgetsVisibility: WidgetsVisibility = {
      ...
      alterations: permissions.canViewAlterations,
      dailyFinance: permissions.canViewGlobalBalances || permissions.canViewExpenses || permissions.canViewDailyFlow,
