...
const ProductsFilters: React.FC<ProductsFiltersProps> = ({
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-4 mb-6">
      ...
      {/* Extended Filters */}
      {showFilters && (
        <div className="mt-4 pt-4 border-t border-stone-200 flex flex-wrap items-center gap-4">
          {/* School Filter */}
          {activeTab === 'school' && availableSchools.length > 1 && (
            <div className="flex flex-col">
              <label className="text-xs text-stone-500 mb-1">Colegio</label>
              <select
                value={schoolFilter}
          ...
          {/* Garment Type Filter (school + global) */}
          {(activeTab === 'school' || activeTab === 'global') && garmentTypes.length > 0 && (
            <div className="flex flex-col">
              <label className="text-xs text-stone-500 mb-1">Tipo de Prenda</label>
              <select
          ...
          {/* Size Filter */}
          <div className="flex flex-col">
            <label className="text-xs text-stone-500 mb-1">Talla</label>
            <select
              value={sizeFilter}
