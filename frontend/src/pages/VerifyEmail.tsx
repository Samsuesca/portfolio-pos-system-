    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-stone-800">Verificacion de Correo</h1>
        </div>
        ...
        <div className="text-center">
          {status === 'loading' && (
            <div className="py-8">
              ...
              <p className="text-stone-600">Verificando tu correo electronico...</p>
            </div>
          )}
          ...
          {status === 'success' && (
            <div className="py-8">
              ...
              <h2 className="text-xl font-semibold text-stone-800 mb-2">Correo Verificado</h2>
              <p className="text-stone-600 mb-2">{message}</p>
              {newEmail && (
                <p className="text-sm text-stone-500">
                  Tu nuevo correo es: <span className="font-medium text-stone-700">{newEmail}</span>
                </p>
              )}
              <button
          ...
          {status === 'error' && (
            <div className="py-8">
              ...
              <h2 className="text-xl font-semibold text-stone-800 mb-2">Error de Verificacion</h2>
              ...
              <button
                onClick={() => navigate('/login')}
                className="px-6 py-2 bg-stone-600 hover:bg-stone-700 text-white rounded-lg transition flex items-center mx-auto"
              >
                <ArrowLeft className="w-4 h-4 mr-2" />
                Volver al Inicio
              </button>
