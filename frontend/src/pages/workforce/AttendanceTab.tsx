  ...
  return (
    <div className="space-y-4">
      ...
      {summary && (
        <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
          <div className="bg-white rounded-lg border border-stone-200 p-4 text-center">
            <p className="text-2xl font-bold text-stone-900">{summary.total_employees}</p>
          ...
          <div className="bg-white rounded-lg border border-stone-200 p-4 text-center">
            ...
            <p className="text-xs text-stone-500 mt-1">Ausentes</p>
          </div>
          <div className="bg-white rounded-lg border border-stone-200 p-4 text-center">
            <p className="text-2xl font-bold text-yellow-600">{summary.late}</p>
            <p className="text-xs text-stone-500 mt-1">Tarde</p>
          </div>
          <div className="bg-white rounded-lg border border-stone-200 p-4 text-center">
            <p className="text-2xl font-bold text-stone-400">{summary.not_logged}</p>
            <p className="text-xs text-stone-500 mt-1">Sin Registrar</p>
          </div>
        </div>
      )}
      ...
      {subTab === 'attendance' && (
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="text-lg font-semibold text-stone-900">Registros de Asistencia</h3>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 border border-stone-200 rounded-lg text-sm focus:ring-2 focus:ring-brand-500 focus:border-brand-500 disabled:bg-stone-100"
                    >
              ...
              <table className="w-full text-sm">
                <thead className="bg-stone-50 border-b border-stone-200">
                  <tr>
                    ...
                    <th className="text-left px-4 py-3 font-medium text-stone-600">Entrada</th>
                    <th className="text-left px-4 py-3 font-medium text-stone-600">Salida</th>
                    <th className="text-left px-4 py-3 font-medium text-stone-600">Min. Tarde</th>
                ...
                <tbody className="divide-y divide-stone-100">
                  {records.map((rec) => (
                    <tr key={rec.id} className="hover:bg-stone-50">
                      ...
                      <td className="px-4 py-3 text-stone-600">{rec.check_in_time || '-'}</td>
                      <td className="px-4 py-3 text-stone-600">{rec.check_out_time || '-'}</td>
      ...
      {subTab === 'absences' && (
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="text-lg font-semibold text-stone-900">Faltas y Ausencias</h3>
          ...
          {showAbsenceModal && (
            <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center">
              <div className="bg-white rounded-lg shadow-xl w-full max-w-lg mx-4 p-6 space-y-4">
                <div className="flex items-center justify-between">
                  <h3 className="text-lg font-semibold text-stone-900">Registrar Falta</h3>
                  <button
                    className="p-1 text-stone-400 hover:text-stone-600"
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <label htmlFor="is-deductible" className="text-sm text-stone-700">
                      Es deducible
                    </label>
                  </div>
          ...
          {loadingAbsences ? (
            <div className="text-center py-8 text-stone-500">Cargando faltas...</div>
          ) : absences.length === 0 ? (
            <div className="text-center py-8 text-stone-500">
              ...
              <table className="w-full text-sm">
                <thead className="bg-stone-50 border-b border-stone-200">
                  <tr>
                    ...
                    <th className="text-left px-4 py-3 font-medium text-stone-600">Justificacion</th>
                    <th className="text-left px-4 py-3 font-medium text-stone-600">Deducible</th>
                    <th className="text-left px-4 py-3 font-medium text-stone-600">Monto</th>
                    <th className="text-left px-4 py-3 font-medium text-stone-600">Aprobado</th>
                    <th className="text-right px-4 py-3 font-medium text-stone-600">Acciones</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-stone-100">
                  {absences.map((abs) => (
                    <tr key={abs.id} className="hover:bg-stone-50">
                      <td className="px-4 py-3 font-medium text-stone-900">
                        {abs.employee_name || '-'}
                      </td>
                      <td className="px-4 py-3 text-stone-600">
                      ...
                      <td className="px-4 py-3">
                        {abs.approved_by ? (
                          <span className="px-2 py-1 rounded-full text-xs font-medium bg-emerald-50 text-emerald-700 ring-1 ring-emerald-200">
                            Aprobado
                          </span>
                        ) : (
