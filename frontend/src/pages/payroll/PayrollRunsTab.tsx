      ...
      <div className="bg-white rounded-xl shadow-sm border border-stone-200 overflow-hidden">
        <table className="min-w-full divide-y divide-stone-100">
          <thead className="bg-stone-50">
            <tr>
              <th className="px-6 py-3 text-left text-xs font-medium text-stone-500 uppercase">Periodo</th>
              <th className="px-6 py-3 text-left text-xs font-medium text-stone-500 uppercase">Empleados</th>
              <th className="px-6 py-3 text-left text-xs font-medium text-stone-500 uppercase">Total Neto</th>
              <th className="px-6 py-3 text-left text-xs font-medium text-stone-500 uppercase">Estado</th>
              <th className="px-6 py-3 text-left text-xs font-medium text-stone-500 uppercase">Creado</th>
          ...
          <tbody className="bg-white divide-y divide-stone-100">
            {runs.length === 0 ? (
              ...
              runs.map((run) => (
                <tr key={run.id} className="hover:bg-stone-50 cursor-pointer" onClick={() => onOpenDetail(run)}>
