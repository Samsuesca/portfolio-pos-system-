...
export const GeneralSection: React.FC<SectionProps> = ({ form, onChange }) => (
  <div className="space-y-4">
    <h4 className="text-lg font-semibold text-stone-800 mb-4">Informacion General</h4>
    <div className="grid grid-cols-2 gap-4">
      ...
      <div className="col-span-2 sm:col-span-1">
        <label className="block text-sm font-medium text-stone-700 mb-1">Nombre Corto</label>
        <input
          type="text"
          ...
          placeholder="UCR"
        />
        <p className="text-xs text-stone-500 mt-1">Se usa en espacios reducidos</p>
      </div>
      <div className="col-span-2">
        <label className="block text-sm font-medium text-stone-700 mb-1">Eslogan</label>
        <input
          type="text"
          value={form.tagline || ''}
...
export const ContactSection: React.FC<SectionProps> = ({ form, onChange }) => (
  <div className="space-y-4">
    <h4 className="text-lg font-semibold text-stone-800 mb-4">Informacion de Contacto</h4>
    <div className="grid grid-cols-2 gap-4">
      <div>
        <label className="block text-sm font-medium text-stone-700 mb-1">Telefono Principal</label>
        <input
          type="tel"
      ...
      <div>
        <label className="block text-sm font-medium text-stone-700 mb-1">Telefono Soporte</label>
        <input
          type="tel"
      ...
      <div className="col-span-2">
        ...
        />
        <p className="text-xs text-stone-500 mt-1">Sin + ni espacios (para links de WhatsApp)</p>
      </div>
      <div>
        ...
        />
        <p className="text-xs text-stone-500 mt-1">Email publico</p>
      </div>
      <div>
        <label className="block text-sm font-medium text-stone-700 mb-1">Email de Envio</label>
        <input
          type="email"
        ...
        />
        <p className="text-xs text-stone-500 mt-1">Para notificaciones</p>
      </div>
    </div>
  </div>
);
...
export const AddressSection: React.FC<SectionProps> = ({ form, onChange }) => (
  <div className="space-y-4">
    <h4 className="text-lg font-semibold text-stone-800 mb-4">Ubicacion</h4>
    <div className="grid grid-cols-1 gap-4">
      <div>
        <label className="block text-sm font-medium text-stone-700 mb-1">Direccion Linea 1</label>
        <input
          type="text"
      ...
      <div>
        <label className="block text-sm font-medium text-stone-700 mb-1">Direccion Linea 2</label>
        <input
          type="text"
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div>
          <label className="block text-sm font-medium text-stone-700 mb-1">Pais</label>
          <input
            type="text"
            value={form.country || ''}
      ...
      <div>
        <label className="block text-sm font-medium text-stone-700 mb-1">URL Google Maps</label>
        <input
          type="url"
          value={form.maps_url || ''}
        ...
        />
        <p className="text-xs text-stone-500 mt-1">Link para abrir en Maps</p>
      </div>
    </div>
  </div>
);
...
export const HoursSection: React.FC<SectionProps> = ({ form, onChange }) => (
  <div className="space-y-4">
    <h4 className="text-lg font-semibold text-stone-800 mb-4">Horarios de Atencion</h4>
    <div className="grid grid-cols-1 gap-4">
      <div>
        <label className="block text-sm font-medium text-stone-700 mb-1">Lunes a Viernes</label>
        <input
          type="text"
      ...
      <div>
        <label className="block text-sm font-medium text-stone-700 mb-1">Sabados</label>
        <input
          type="text"
      ...
      <div>
        <label className="block text-sm font-medium text-stone-700 mb-1">Domingos</label>
        <input
          type="text"
...
export const WebSection: React.FC<SectionProps> = ({ form, onChange }) => (
  <div className="space-y-4">
    <h4 className="text-lg font-semibold text-stone-800 mb-4">Web y Redes Sociales</h4>
    <div className="grid grid-cols-1 gap-4">
      <div>
      ...
      <div>
        ...
        />
        <p className="text-xs text-stone-500 mt-1">Dejar vacio si no aplica</p>
      </div>
      <div>
