        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-xl shadow-sm border border-stone-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-stone-500">Liquidez Total</p>
                <p className="text-2xl font-bold text-green-600 mt-1">{formatCurrency(dashboard.cash_balance)}</p>
                <p className="text-xs text-stone-400">Caja + Banco</p>
              </div>
          ...
          <button
            ...
            className="bg-white rounded-xl shadow-sm border border-stone-200 p-6 text-left hover:shadow-md hover:border-red-300 transition-all cursor-pointer"
          >
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-stone-500">Gastos Totales</p>
                <p className="text-2xl font-bold text-red-600 mt-1">{formatCurrency(dashboard.total_expenses)}</p>
                <p className="text-xs text-stone-400">{dashboard.transaction_count} registro(s) - Click para ver</p>
              </div>
          ...
          <button
            onClick={onGoToExpenses}
            className="bg-white rounded-xl shadow-sm border border-stone-200 p-6 text-left hover:shadow-md hover:border-orange-300 transition-all cursor-pointer"
          >
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-stone-500">Gastos Pendientes</p>
                <p className="text-2xl font-bold text-orange-600 mt-1">{formatCurrency(dashboard.expenses_pending)}</p>
                <p className="text-xs text-stone-400">Por pagar - Click para ver</p>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-stone-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-stone-500">Balance Neto</p>
                ...
                <p className="text-xs text-stone-400">Liquidez - Pendientes</p>
              </div>
      ...
      {cashBalances && (
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-brand-200 p-5">
              <div className="flex items-center justify-between mb-3">
                <div>
              ...
              <div className="border-t border-brand-200 pt-3 space-y-2">
                <div className="flex items-center justify-between text-sm">
                  <span className="text-brand-600">Nequi</span>
                  <div className="flex items-center gap-2">
                ...
                <div className="flex items-center justify-between text-sm">
                  <span className="text-brand-600">Cuenta Bancaria</span>
                  <div className="flex items-center gap-2">
                    <span className="font-medium text-brand-700">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-stone-200">
          <div className="px-6 py-4 border-b border-stone-200">
            <h3 className="text-lg font-semibold text-stone-800">Resumen Global</h3>
          </div>
          <div className="p-6">
            <div className="space-y-4">
              <div className="flex items-center justify-between py-2 border-b border-stone-100">
                <span className="text-stone-600">Total de Gastos Registrados</span>
                <span className="font-semibold text-stone-800">{dashboard?.transaction_count || 0}</span>
              </div>
              <div className="flex items-center justify-between py-2 border-b border-stone-100">
                <span className="text-stone-600">Gastos Pagados</span>
                <span className="font-semibold text-green-600">{formatCurrency(dashboard?.expenses_paid || 0)}</span>
              </div>
              <div className="flex items-center justify-between py-2">
                <span className="text-stone-600">Gastos Por Pagar</span>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-stone-200">
          <div className="px-6 py-4 border-b border-stone-200 flex items-center justify-between">
            <h3 className="text-lg font-semibold text-stone-800">Gastos Pendientes</h3>
            <button
          ...
          <div className="divide-y divide-stone-100">
            {pendingExpenses.length === 0 ? (
              <div className="px-6 py-8 text-center text-stone-500">No hay gastos pendientes</div>
            ) : (
              pendingExpenses.slice(0, 8).map((expense) => (
                <div key={expense.id} className="px-6 py-4 hover:bg-stone-50 transition-colors">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      ...
                      <div className="flex items-center justify-end gap-2 mt-1">
                        <button
                          ...
                          className="text-xs text-brand-600 hover:text-brand-700 flex items-center gap-1 px-2 py-1 rounded hover:bg-brand-50 transition"
                          title="Editar gasto"
                        >
