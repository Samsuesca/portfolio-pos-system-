...
const ProfitabilityReport: React.FC<ProfitabilityReportProps> = ({
  ...
  if (!data || data.schools.length === 0) {
    return (
      <div className="bg-white rounded-lg shadow-sm p-8 text-center text-stone-500">
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-stone-100">
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <span className={`text-xs px-2 py-1 rounded-full ${
                        school.cost_coverage_percent >= 80 ? 'bg-emerald-50 text-emerald-700 ring-1 ring-emerald-200' :
                        school.cost_coverage_percent >= 50 ? 'bg-amber-50 text-amber-700 ring-1 ring-amber-200' :
            ...
            <tfoot className="bg-stone-50 font-semibold">
              <tr>
                <td className="px-6 py-4 text-sm text-stone-900">Total</td>
                <td className="px-6 py-4 text-right text-sm text-stone-900">
