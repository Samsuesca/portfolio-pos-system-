      ...
      <div className="bg-white rounded-lg shadow-sm p-4 mb-6">
        <div className="flex flex-col sm:flex-row sm:items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-stone-700">Filtrar por colegio:</span>
          </div>
          <select
            value={salesSchoolFilter}
            onChange={(e) => onSchoolFilterChange(e.target.value)}
            className="px-3 py-2 border border-stone-200 rounded-lg text-sm focus:ring-2 focus:ring-brand-400/30 focus:border-brand-500"
          >
            ...
            <div className="mt-4 pt-4 border-t border-brand-500">
              ...
              <div className="flex flex-wrap gap-4">
                {Object.entries(globalSalesSummary.sales_by_payment).map(([method, data]) => (
                  <div key={method} className="bg-brand-500/30 rounded px-3 py-1">
                    ...
                    <tr key={school.school_id} className="hover:bg-stone-50">
                      <td className="px-6 py-4">
                        <div className="flex items-center">
                          ...
                          <span className="text-sm font-medium text-stone-900">{school.school_name}</span>
                        </div>
                      </td>
                      ...
                      <td className="px-6 py-4 text-right">
                        <div className="flex items-center justify-end gap-2">
                          ...
                          <span className="text-xs text-stone-500 w-10">{percentage}%</span>
                        </div>
                      </td>
                    </tr>
                  );
                        ...
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <div className="text-xs text-stone-500">
                              ...
                              {!salesSchoolFilter && <span className="ml-1 text-brand-500">({product.school_name})</span>}
                            </div>
                          </div>
                        </div>
                      </td>
                        ...
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <div className="text-xs text-stone-500">
                              ...
                              {!salesSchoolFilter && <span className="ml-1 text-brand-500">({client.school_name})</span>}
                            </div>
                          </div>
                        </div>
                      </td>
